...
const NutritionTable = lazy(() =>
    import('./components/NutritionTable/NutritionTable').then((m) => ({ default: m.NutritionTable }))
);
const MenuEditor = lazy(() =>
    import('./components/MenuEditor/MenuEditor').then((m) => ({ default: m.MenuEditor }))
);
const TraineeDashboard = lazy(() =>
    import('./components/TraineeDashboard/TraineeDashboard').then((m) => ({ default: m.TraineeDashboard }))
);
const TraineeWorkoutPanel = lazy(() =>
    import('./containers/TraineeWorkoutPanel/TraineeWorkoutPanel').then((m) => ({
        default: m.TraineeWorkoutPanel,
    }))
);
const TraineeHome = lazy(() =>
    import('./containers/TraineeHome/TraineeHome').then((m) => ({ default: m.TraineeHome }))
);
const Settings = lazy(() =>
    import('./components/Settings/Settings').then((m) => ({ default: m.Settings }))
);
const PaymentsPage = lazy(() =>
    import('./containers/Payments/PaymentsPage').then((m) => ({ default: m.PaymentsPage }))
);
