...
export const NutritionTab: React.FC<INutritionTabProps> = ({ trainee, onUpdate, onEditMenu }) => {
    const [macros, setMacros] = useState({
        ...
        dailyCalories: trainee.goals.dailyCalories ?? 2000,
    });
    ...
    useEffect(() => {
        ...
        trainee.id,
        trainee.goals.proteinTarget,
        trainee.goals.carbsTarget,
        trainee.goals.fatTarget,
        trainee.goals.waterTarget,
        trainee.goals.dailyCalories,
    ]);

    const handleChange = (e: React.ChangeEvent<HTMLInputElement>, key: keyof typeof macros) => {
            ...
            <div className="macros-overview">
                <div className="macro-card">
                    ...
                    <input
                        ...
                        onChange={(e) => handleChange(e, 'dailyCalories')}
                    />
                </div>
                <div className="macro-card">
